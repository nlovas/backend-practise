    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        validationSchema: yup__WEBPACK_IMPORTED_MODULE_8__["object"]().shape({
          ...
          password: yup__WEBPACK_IMPORTED_MODULE_8__["string"]().required("Required").min(6, "Password must be at least 6 characters long").max(20, "Password is too long").matches(/^[a-zA-Z0-9!@#$%^&*\-\_]*$/, "Password must contain: one or more lowercase letters, uppercase letters, a number, and a symbol(!@#$%^&*-_) with no spaces"),
...
//# sourceMappingURL=signup.js.f8fd8e4d6e23c59c307f.hot-update.js.map