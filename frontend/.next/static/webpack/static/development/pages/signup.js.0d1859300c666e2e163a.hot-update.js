    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        validationSchema: yup__WEBPACK_IMPORTED_MODULE_8__["object"]().shape({
          ...
          password: yup__WEBPACK_IMPORTED_MODULE_8__["string"]().required("Required").min(6, "Password must be at least 6 characters long").max(20, "Password is too long").matches(/(?=(.*[0-9]))(?=.*[\!@#$%^&*\-_.])(?=.*[a-z])(?=(.*[A-Z]))(?=(.*))^[A-Za-z0-9\-\_.]*$/, "Password must contain: one or more lowercase letters, uppercase letters, a number, and a symbol(!@#$%^&*-_.) with no spaces or unicode characters"),
...
//# sourceMappingURL=signup.js.0d1859300c666e2e163a.hot-update.js.map