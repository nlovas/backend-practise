...
var Signup = /*#__PURE__*/function (_React$Component) {
  ...
  */
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Signup, [{
    ...
    /*
    Calls api to see if the username or email has already been registered
    */

  }, {
    key: "checkExistence",
    value: function checkExistence(formVal) {
      ...
      return new Promise(function (resolve, reject) {
        axios__WEBPACK_IMPORTED_MODULE_9___default()({
          ...
          console.log(response);
          resolve(false); //TODO: update this line
        }, function (error) {
          console.log(error);
        });
      });
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        validationSchema: yup__WEBPACK_IMPORTED_MODULE_8__["object"]().shape({
          username: yup__WEBPACK_IMPORTED_MODULE_8__["string"]().required("Required").min(3, "Username must be at least 3 characters long").max(20, "Username is too long").matches(/^[A-Za-z0-9\-\_.]*$/, "Username can only use letters, numbers, or special characters(-_.)") //check to see if this username already exists
...
//# sourceMappingURL=signup.js.46ebddf0a82920b026a7.hot-update.js.map