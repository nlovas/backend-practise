...
var Signup = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Signup, [{
    ...
    value: function onInputBlur(event, field) {
      console.log("username had an input blur", event, field); // handleBlur(event);
      //validateField(field);
    }
    /*
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        return __jsx(formik__WEBPACK_IMPORTED_MODULE_7__["Form"], {
          ...
          name: "username",
          type: "text",
          onBlur: function onBlur(event, field) {
            console.log("anything?", event, field); //this.onInputBlur(event, field);
          },
...
//# sourceMappingURL=signup.js.b9cb1b1432f3a8407ada.hot-update.js.map