        ...
        onSubmit: function onSubmit(fields, actions) {
          ...
          _this.checkEmailAvailable(fields.email).then(function (isAvailable) {
            if (isAvailable) {
              ...
              https://jaredpalmer.com/formik/docs/api/withFormik#the-formikbag
              */
              ...
              actions.setFieldError("email", "This email is already in use"); //alert("this email is already in use");
            }
          });
        },
        __self: this,
...
//# sourceMappingURL=signup.js.bd4f1ea9225deecbf513.hot-update.js.map