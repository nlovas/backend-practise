    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        validationSchema: yup__WEBPACK_IMPORTED_MODULE_8__["object"]().shape({
          ...
          password: yup__WEBPACK_IMPORTED_MODULE_8__["string"]().required("Required").min(6, "Password must be at least 6 characters long").max(20, "Password is too long").matches(/[A-Za-z0-9\-\_.](?=(.*[0-9]))(?=.*[\!@#$%^&*\-_.])(?=.*[a-z])(?=(.*[A-Z]))(?=(.*))/, "Password must contain: one or more lowercase letters, uppercase letters, a number, and a symbol(!@#$%^&*-_.)")
          /*
          (?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*\-\_])
...
//# sourceMappingURL=signup.js.60da2a0dc5e2584bda88.hot-update.js.map